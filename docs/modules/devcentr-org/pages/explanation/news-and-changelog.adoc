...
Recent inward craft example: link:https://devcentr.org/news/2026-09-18-what-a-good-install-actually-is[What a good install actually is] (installation norms / UIL essay; changelog xref in this component).
