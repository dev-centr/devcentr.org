...
:description: Public toolchain browser on devcentr.org, synced from dev-centr/toolchain-advisor SDL definitions. Advice is a feature of the browse flow.

`/toolchain-browser` hosts an interactive browse-and-advise flow that matches the SDL definitions used by the DevCentr desktop app.
...
* xref:devcentr::index.adoc[DevCentr] — desktop host for the same definitions
