...
| `/ideas/:slug`
| Idea pages for catalogue entries with `ideaSlug` (`uniconfig`, `uniprovider`, `opr-directory`, `provider-mirror-backups`, `equivalence-engine`)
...
* `src/components/` — shared UI (header, footer, diagrams, stack advisor widget, agent skills catalog, apps catalogue)
