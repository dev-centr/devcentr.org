...
* Planets link to Apps, docs portal, News, Changelog, Skills, Stack Advisor, and the GitHub org.
...
* `src/components/` — shared UI (header, footer, diagrams, Stack Advisor embed, agent skills catalog, `SiteMap` solar system)
