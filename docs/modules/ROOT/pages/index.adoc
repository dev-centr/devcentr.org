...
| Products, services, standards, and idea pages
| xref:explanation/apps-catalog.adoc[Apps catalogue]

| UniProvider, OPR, OPR Directory (September 2026)
| xref:explanation/inference-opr.adoc[Inference & OPR]
