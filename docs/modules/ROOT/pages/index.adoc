...
* **Public tools** — Toolchain Browser (`/toolchain-browser`; `/toolchain-advisor` redirects), agent skills (`/skills`), resting-lanczos demo (`/resting-lanczos`), and apps catalogue (`/apps`).
...
| SDL catalog sync and `/toolchain-browser`
| xref:explanation/toolchain-browser.adoc[Toolchain Browser]
