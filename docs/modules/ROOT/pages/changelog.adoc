...
* Homepage destinations are a teal-white dwarf with overlapping orbits. Planets shade from the star, shrink/fade on the far side, and show a label on hover.
