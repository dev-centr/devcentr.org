...
* Stack Advisor catalog adds `desktop-rendering-engines` guidance with a link to xref:general-knowledge::explanation/architecture/graphics-rendering-engines.adoc[graphics-rendering-engines] in general-knowledge.
...
* The `@dev-centr/stack-advisor` package shows a **Read docs** link when the best recommendation includes a `docs` URL.
