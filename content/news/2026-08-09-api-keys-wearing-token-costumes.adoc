...
Product enforcement: link:https://docs.devcentr.org/platforms/devcentr/latest/secrets-manager/explanation/api-key-vs-token.html[Secrets Manager vocabulary].
