...
Release: link:https://github.com/dev-centr/msi-generator/releases/tag/v0.2.0[v0.2.0] · docs: link:https://docs.devcentr.org/tools/msi-generator/latest/index.html[component].
