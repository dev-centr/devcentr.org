...
export default function HealthPage() {
  ...
  return (
    <div class="plane-surface relative min-h-dvh">
      <Title>Service health · DevCentr</Title>
      <Meta
        name="description"
        content="Live probe of DevCentr public services — landing site, docs, app, news feeds, and GitHub."
      />
      <Meta name="keywords" content="DevCentr, health, status, uptime, blog, news" />
